...
g++ -o bin/raspTrain $LIB_ROOT/BasePinHandler.o $LIB_ROOT/main.o $LIB_ROOT/PwmPinHandler.o $LIB_ROOT/SwitchPinHandler.o $LIB_ROOT/QueueMessageHandler.o -lwiringPi -lpthread -lzmq
